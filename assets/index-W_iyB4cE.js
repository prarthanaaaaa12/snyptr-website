      ...
      `}),(0,j.jsxs)(`nav`,{className:`navbar ${e?`navbar--scrolled`:``}`,children:[(0,j.jsxs)(A,{to:`/`,className:`navbar__logo`,children:[`SNYPTR`,(0,j.jsx)(`span`,{className:`navbar__logo-dot`})]}),(0,j.jsx)(`ul`,{className:`navbar__links`,children:a.map(({to:e,label:t})=>(0,j.jsx)(`li`,{children:t===`Shop`?(0,j.jsx)(A,{to:e,className:`navbar__cta ${i.pathname===e?`active`:``}`,children:t}):(0,j.jsx)(A,{to:e,className:i.pathname===e?`active`:``,children:t})},e))}),(0,j.jsxs)(`button`,{className:`navbar__hamburger ${n?`open`:``}`,onClick:()=>r(!n),"aria-label":`Menu`,children:[(0,j.jsx)(`span`,{}),(0,j.jsx)(`span`,{}),(0,j.jsx)(`span`,{})]})]}),(0,j.jsx)(`div`,{className:`navbar__mobile ${n?`open`:``}`,children:a.map(({to:e,label:t})=>(0,j.jsx)(A,{to:e,children:t},e))})]})}function Yn(){let e=(0,_.useRef)(null);return(0,_.useEffect)(()=>{let t=e.current;if(!t)return;let n=e=>{t.style.left=e.clientX+`px`,t.style.top=e.clientY+`px`},r=()=>t.classList.add(`cursor--hover`),i=()=>t.classList.remove(`cursor--hover`),a=()=>{t.classList.add(`cursor--click`),setTimeout(()=>t.classList.remove(`cursor--click`),250)};return document.body.style.cursor=`none`,document.documentElement.style.cursor=`none`,window.addEventListener(`mousemove`,n,{passive:!0}),window.addEventListener(`click`,a),document.querySelectorAll(`a, button`).forEach(e=>{e.addEventListener(`mouseenter`,r),e.addEventListener(`mouseleave`,i)}),()=>{window.removeEventListener(`mousemove`,n),window.removeEventListener(`click`,a),document.body.style.cursor=``,document.documentElement.style.cursor=``}},[]),(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(`style`,{children:`
        *, *::before, *::after { cursor: none !important; }
        ...
        .cursor {
          ...
          width: 40px;
          height: 40px;
          /* center the SVG on the actual cursor point */
          transform: translate(-50%, -50%);
          top: 0;
          left: 0;
          /* NO transition on position — that's what causes lag */
        }

        .cursor svg {
          width: 100%;
          height: 100%;
          filter: drop-shadow(0 0 5px rgba(232,0,13,0.9));
